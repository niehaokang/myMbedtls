 ...
 * \brief          MPI structure
 */
typedef struct __mbedtls_mpi__
{
    int s;              /*!<  integer sign      */
...
/**
 * \brief          Modulo: r = A * B mod C
 *
 * \param R        Destination mbedtls_mpi_uint
 * \param A        Left-hand MPI A
 * \param B        Left-hand MPI B
 * \param C        MPI to divide by
 *
 * \return         0 if successful,
 *
 */
...
/**
 * \brief          exponentiation : X = 2^b
 *
 * \param X        Destination MPI
 * \param b        The integer value to Exponent
 *
 * \return         0 if successful,
 *                 MBEDTLS_ERR_MPI_ALLOC_FAILED if memory allocation failed
 */
